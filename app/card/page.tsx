...
/*  NOTE: fixed here — the earlier standalone component had leftover  */
/*  "SmhartPay" copy from an unrelated project. Quotes below are the  */
/*  real Raenest testimonials pulled from the live /cards page.       */
/* ------------------------------------------------------------------ */
