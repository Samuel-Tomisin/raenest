...
const testimonials = [
  { quote: "Raenest has been a super useful platform for us. We started to use them to pay staff and vendors right after they launched and it hasn't failed us one bit.", name: "Seun Alley", role: "Chief Executive Officer", company: "Fez", photo: "/images/business/testimonials/seun-alley.jpg" },
