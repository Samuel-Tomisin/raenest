      ...
      <div className="mx-auto max-w-[1200px] px-6 py-14">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[200px_1fr]">
          ...
          <div className="max-w-3xl">
            <p className="text-[15.5px] text-[#3A3A42]">
              Privacy Policy for {COMPANY_LEGAL_NAME}
            </p>
            ...
            <div className="mt-8 space-y-6 text-[15px] leading-relaxed text-[#3A3A42]">
              ...
              <div>
                ...
                <p className="mt-2">
                  [Placeholder]{" "}
                  <a href="#" className="text-[#4F3DF5] underline">
                    {COMPANY_DOMAIN}
                  </a>{" "}
                  is provided by {COMPANY_LEGAL_NAME} (&quot;{COMPANY_NAME}&quot;).
                </p>
                <p className="mt-2">
                  [Placeholder] At {COMPANY_NAME}, we value your privacy, and we are committed to
                ...
                <p className="mt-2">
                  [Placeholder] Throughout the website, the terms &quot;we&quot;, &quot;us&quot;
                  and &quot;our&quot; refer to {COMPANY_NAME}.
                </p>
                <p className="mt-2">
                  [Placeholder] This Privacy Policy is specifically designed for our Users who
                ...
                <p className="mt-2">
                  [Placeholder] Your use of our services, and any dispute over privacy, is subject
              ...
              <div>
                ...
                <p className="mt-1">
                  [Placeholder] means the consent of the data subject which must be a freely
                ...
                <p className="mt-1">
                  [Placeholder] means a living, identified, or identifiable individual about whom{" "}
                  {COMPANY_NAME} holds personal data.
                </p>
                <p className="mt-3 font-semibold">&quot;Data Protection Legislation&quot;</p>
                <p className="mt-1">
                  [Placeholder] means all applicable data protection and privacy laws in [your
                  jurisdiction], and any successor legislation.
                </p>
                <p className="mt-3 font-semibold">&quot;personal data&quot;</p>
                <p className="mt-1">
                  [Placeholder] means any information relating to a data subject who can be
                ...
                <p className="mt-1">
                  [Placeholder] means a breach of security leading to the accidental or unlawful
              ...
              <div>
                ...
                <p className="mt-2">
                  [Placeholder] Where the processing of your personal data is based on consent, we
              ...
              <div>
                ...
                <p className="mt-2">
                  [Placeholder] Describe your minimum age requirement and how you handle data from
                  minors here.
                </p>
              </div>
