...
import { Users, Plus, ShieldCheck, Landmark, ShieldAlert, Play } from "lucide-react";
  ...
  return (
    <section className="bg-black px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div
          className="relative h-130 overflow-hidden rounded-4xl bg-neutral-900 bg-cover bg-center bg-no-repeat transition-[background-image] duration-500 sm:h-130"
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {INVOICE_STEPS.map((step) => (
            <div key={step.number} className="flex flex-col">
              <div className="relative flex flex-col overflow-hidden rounded-3xl bg-linear-to-b from-primary to-[#3D2299] px-8 py-45">
